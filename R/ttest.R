#' Welch test with given mean, standard deviations and sample sizes
#' Till Dettmering, tilldettmering(at)gmail.com
#' 
#' @param ctrl.x Mean of control
#' @param ctrl.sd SD of control
#' @param ctrl.n Sample size of control
#' @param smpl.x Mean of sample
#' @param smpl.sd SD of sample
#' @param smpl.n Sample size of sample
#' @param rpl List of corresponding replicate counts
#' @export
